...
INSERT INTO `city` (`id_country`, `name`) VALUES ('2', 'Boston');



insert into category values (1,'Computers','This is about computers.');
insert into product values (1,1,'Computer1',399.99,'static/images/computers/1.png',4.0);
